...
type TransactionsHistoryContainerProps = TransactionsHistoryContainerMobxProps &
  TransactionsHistoryContainerOwnProps;
      ...
      <Grid item xs={12}>
        <Card className={classes.transactionsHistoryCard}>
          <CardHeader
            title={
              selectedAccount
                ? `Transactions history of ${selectedAccount}`
...
const mapMobxToProps = (
  state: IAppState
): TransactionsHistoryContainerMobxProps => ({
...
export const TransactionsHistoryContainer = inject(mapMobxToProps)(
  observer(_TransactionsHistoryContainer) as FunctionComponent<
    TransactionsHistoryContainerOwnProps
  >
);
