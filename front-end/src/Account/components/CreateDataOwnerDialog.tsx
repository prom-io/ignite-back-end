...
type CreateDataOwnersDialogProps = CreateDataOwnersDialogMobxProps &
  WithMobileDialog;
  ...
  >
    <div style={{ padding: 15 }}>
      ...
      <DialogActions>
        ...
        {uploadDataResponse ? (
          <Button onClick={resetDataUpload} color="primary" variant="text">
...
export const CreateDataOwnerDialog = withMobileDialog()(
  inject(mapMobxToProps)(observer(_CreateDataOwnerDialog) as FunctionComponent)
);
