...
export class UsersController {
    ...
    @Get("accounts/subscribed-communities")
    public getSubscibedCommunitiesOfUser(@Req() request: Request) {
        return this.userSubscriptionsService.getSubscibedCommunitiesOfUser(request.user as User)
    }
    ...
    @UseInterceptors(ClassSerializerInterceptor)
    @UseGuards(AuthGuard("jwt"))
    @Get("accounts/follow-recommendations")
    ...
    @UseGuards(AuthGuard("jwt"))
    @Get("accounts/current/subscriptions")
    ...
    @Get("accounts/:address/subscriptions")
    ...
    @Get("accounts/current/memezator-actions-rights")
    ...
    @UseInterceptors(ClassSerializerInterceptor)
    @UseGuards(AuthGuard("jwt"))
    @Post("accounts/:address/unfollow")
    ...
    @UseGuards(OptionalJwtAuthGuard)
    @UseInterceptors(ClassSerializerInterceptor)
    @Get("accounts/:address/followers")
    ...
    @UseGuards(OptionalJwtAuthGuard)
    @UseInterceptors(ClassSerializerInterceptor)
    @Get("accounts/:address/following")
    ...
    @Get("accounts/username/:username/is-available")
